export const aboutContent = {
  title: "About Us",
  description:
    "Tha Shop in Magnolia, TX — auto and motorcycle repair, restoration, and custom builds. Real craftsmanship, clear talk, work done right.",
  mission: {
    title: "How we work",
  ...
  imageAlt: "Restored cherry-red Ford pickup on the Tha Shop floor",
} as const;
...
export const services = {
  auto: {
    ...
    metaDescription:
      "Diagnostics, factory maintenance, brakes, suspension, electrical, and drivetrain repair at Tha Shop in Magnolia, TX.",
  ...
  motorcycle: {
    ...
    metaDescription:
      "Motorcycle maintenance, tires, brakes, chain service, and performance upgrades at Tha Shop in Magnolia, TX.",
  ...
  fleet: {
    ...
    metaDescription:
      "Priority fleet scheduling, preventive maintenance, and digital service records from Tha Shop in Magnolia, TX.",
  ...
  fabrication: {
    ...
    metaDescription:
      "Custom metal fabrication, project builds, and durable signage from Hotrod Fabrication at Tha Shop in Magnolia, TX.",
  ...
  crazyEight: {
    ...
    metaDescription:
      "Custom and performance builds for hot rods, Harleys, antiques, and classics from Crazy Eight Customs at Tha Shop in Magnolia, TX.",
    h1: "Custom and performance builds, from sketch to finished machine",
    intro:
      "Crazy Eight Customs is the custom and performance bay at Tha Shop — motorcycles, hot rods, antiques, and classics built the way you pictured them, with clear updates through the job.",
    body: [
...
export const galleryPages = {
  cars: {
    title: "Car Gallery",
    metaDescription:
      "Photos of custom builds, repairs, and car projects from Tha Shop in Magnolia, TX.",
    ...
    images: [
      {
        src: "/images/gallery/cars/1.jpg",
        alt: "Custom car project at Tha Shop",
      },
      {
        src: "/images/gallery/cars/2.jpg",
        alt: "Finished car detail work at Tha Shop",
      },
      {
        src: "/images/gallery/cars/3.jpg",
        alt: "Classic car in the Tha Shop garage",
      },
      {
        src: "/images/gallery/cars/4.jpg",
        alt: "Performance car build at Tha Shop",
      },
      {
        src: "/images/gallery/cars/5.jpg",
        alt: "Car restoration progress at Tha Shop",
      },
      {
        src: "/images/gallery/cars/6.jpg",
        alt: "Custom paint and body work at Tha Shop",
      },
      {
        src: "/images/gallery/cars/7.jpg",
        alt: "Shop project vehicle at Tha Shop",
      },
      {
        src: "/images/gallery/cars/8.jpg",
        alt: "Completed car service project at Tha Shop",
      },
      {
        src: "/images/gallery/cars/home-1.jpg",
        alt: "Vehicle lineup at Tha Shop",
      },
      ...
      },
      {
        ...
        alt: "Finished automotive project",
      },
    ],
  },
  trucks: {
    title: "Truck Gallery",
    metaDescription:
      "Truck builds, lifts, and repair projects photographed at Tha Shop in Magnolia, TX.",
    h1: "Trucks from the shop floor",
    intro:
      "Lifts, custom work, and heavy-duty repairs — a sample of the trucks that come through Tha Shop.",
    images: [
      { src: "/images/gallery/trucks/1.jpg", alt: "Custom truck at Tha Shop" },
      {
        src: "/images/gallery/trucks/2.jpg",
        alt: "Lifted truck project at Tha Shop",
      },
      {
        src: "/images/gallery/trucks/3.jpg",
        alt: "Truck repair and build work",
      },
      { src: "/images/gallery/trucks/4.jpg", alt: "Shop truck project detail" },
      {
        src: "/images/gallery/trucks/5.jpg",
        alt: "Completed truck build at Tha Shop",
      },
      {
        src: "/images/gallery/trucks/6.jpg",
        alt: "Truck customization at Tha Shop",
      },
      {
        src: "/images/gallery/trucks/7.jpg",
        alt: "Heavy-duty truck service project",
      },
      { src: "/images/gallery/trucks/8.jpg", alt: "Truck on the Tha Shop lot" },
    ],
  },
  motorcycles: {
    title: "Motorcycle Gallery",
    metaDescription:
      "Motorcycle builds, customs, and service projects from Tha Shop in Magnolia, TX.",
    ...
    images: [
      ...
      },
      {
        ...
        alt: "Harley or cruiser project at Tha Shop",
      },
      {
        src: "/images/gallery/motorcycles/6.jpg",
        alt: "Motorcycle detail and chrome work",
      },
      {
        src: "/images/gallery/motorcycles/7.jpg",
        alt: "Shop motorcycle lineup",
      },
      {
        src: "/images/gallery/motorcycles/8.jpg",
        alt: "Custom bike at Tha Shop",
      },
    ],
  },
  events: {
    ...
    metaDescription:
      "Photos from motorcycle rallies, shop gatherings, and community events with Tha Shop.",
    ...
    images: [
      {
        src: "/images/gallery/events/burnout-bash.jpg",
        alt: "Burnout Bash event",
      },
      {
        src: "/images/gallery/events/1000017766.jpg",
        alt: "Shop event crowd and bikes",
      },
      {
        src: "/images/gallery/events/1000017768.jpg",
        alt: "Motorcycle event photo",
      },
      {
        src: "/images/gallery/events/1000017769.jpg",
        alt: "Riders at a Tha Shop event",
      },
      {
        src: "/images/gallery/events/1000017770.jpg",
        alt: "Event bikes on display",
      },
      {
        src: "/images/gallery/events/1000017771.jpg",
        alt: "Community motorcycle gathering",
      },
      {
        src: "/images/gallery/events/1000017772.jpg",
        alt: "Shop event highlight",
      },
      {
        src: "/images/gallery/events/1000017773.jpg",
        alt: "Riders and customs at an event",
      },
      {
        src: "/images/gallery/events/1000017774.jpg",
        alt: "Event day at the shop community",
      },
      {
        src: "/images/gallery/events/1000018039.jpg",
        alt: "Motorcycle rally photo",
      },
      {
        src: "/images/gallery/events/1000018470.jpg",
        alt: "Show bike at a local event",
      },
      {
        src: "/images/gallery/events/1000018482.jpg",
        alt: "Event staging and bikes",
      },
      {
        src: "/images/gallery/events/1000018484.jpg",
        alt: "Custom motorcycle at a show",
      },
      {
        src: "/images/gallery/events/1000018486.jpg",
        alt: "Crowd and machines at an event",
      },
      {
        src: "/images/gallery/events/1000018487.jpg",
        alt: "Night event motorcycle lineup",
      },
      {
        src: "/images/gallery/events/1000018488.jpg",
        alt: "Shop community event photo",
      },
      {
        src: "/images/gallery/events/1000018489.jpg",
        alt: "Riders gathered for an event",
      },
      {
        src: "/images/gallery/events/IMG_8255.jpg",
        alt: "Event photo from Tha Shop community",
      },
      {
        src: "/images/gallery/events/IMG_8258_108.jpg",
        alt: "Motorcycle event action shot",
      },
      {
        src: "/images/gallery/events/IMG_8272.jpg",
        alt: "Show floor motorcycles",
      },
      {
        src: "/images/gallery/events/IMG_8277.jpg",
        alt: "Custom bike at community event",
      },
      {
        src: "/images/gallery/events/IMG_8279.jpg",
        alt: "Event attendees and bikes",
      },
      {
        src: "/images/gallery/events/IMG_8280.jpg",
        alt: "Tha Shop event gallery photo",
      },
    ],
  },
} as const;
